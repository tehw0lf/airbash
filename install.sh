...
# seed database
sqlite3 "$installation_path/.database.sqlite3" "CREATE TABLE IF NOT EXISTS captures (id INTEGER PRIMARY KEY NOT NULL, latitude VARCHAR(12), longitude VARCHAR(12), bssid VARCHAR(17) UNIQUE, essid VARCHAR(255), pmkid VARCHAR(255), psk VARCHAR(64), processed INT(1) DEFAULT 0)"
